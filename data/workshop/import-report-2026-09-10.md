...
Generated 2026-09-10. Source: `PERFIS DE IMPLEMENTAÇÃO FAIR 2.docx` (sha256[:12] `9bf9d1d728cb`).
...
- Options offered as free-text phrases, not FAIR Enabling Resources (data/fers/aliases-workshop.md or a human "skip" override; spec 10-suggested-phrases-and-other.md `suggestedPhrases`): 74 distinct texts (293 occurrences across areas)
- suggestedPhrases entries written to models: 293 total, max 7 on one question
...
- Options offered as free-text phrases (not FERs): 49
- suggestedPhrases entries written: 49
- Type mismatches (suggestion kept, see report section below): 25
  - F1-metadata: 8 suggested option(s), 1 phrase(s)
  - F1-data: 9 suggested option(s)
  - F2: 7 suggested option(s), 2 phrase(s)
  - F3: 4 suggested option(s), 2 phrase(s)
  - F4-metadata: 10 suggested option(s)
  - F4-data: 10 suggested option(s)
  - A1.1-metadata: 4 suggested option(s), 2 phrase(s)
  - A1.1-data: 2 suggested option(s), 4 phrase(s)
  - A1.2-metadata: 2 suggested option(s), 4 phrase(s)
  - A1.2-data: 0 suggested option(s), 6 phrase(s)
  - A2: 0 suggested option(s), 7 phrase(s)
  - I1-metadata: 6 suggested option(s), 1 phrase(s)
  - I1-data: 7 suggested option(s), 2 phrase(s)
  - I2-metadata: 9 suggested option(s), 1 phrase(s)
  - I2-data: 9 suggested option(s), 1 phrase(s)
  - I3-metadata: 15 suggested option(s)
  - R1.1-metadata: 2 suggested option(s), 3 phrase(s)
  - R1.1-data: 2 suggested option(s), 6 phrase(s)
  - R1.2-metadata: 5 suggested option(s), 2 phrase(s)
  - R1.2-data: 4 suggested option(s), 5 phrase(s)
...
- Options offered as free-text phrases (not FERs): 63
- suggestedPhrases entries written: 63
- Type mismatches (suggestion kept, see report section below): 12
  - F1-metadata: 3 suggested option(s), 2 phrase(s)
  - F1-data: 3 suggested option(s), 2 phrase(s)
  - F2: 5 suggested option(s), 1 phrase(s)
  - F3: 2 suggested option(s), 2 phrase(s)
  - F4-metadata: 3 suggested option(s), 2 phrase(s)
  - F4-data: 4 suggested option(s), 2 phrase(s)
  - A1.1-metadata: 3 suggested option(s), 4 phrase(s)
  - A1.1-data: 2 suggested option(s), 5 phrase(s)
  - A1.2-metadata: 2 suggested option(s), 4 phrase(s)
  - A1.2-data: 0 suggested option(s), 6 phrase(s)
  - A2: 0 suggested option(s), 7 phrase(s)
  - I1-metadata: 5 suggested option(s), 2 phrase(s)
  - I1-data: 5 suggested option(s), 2 phrase(s)
  - I2-metadata: 4 suggested option(s), 2 phrase(s)
  - I2-data: 5 suggested option(s), 3 phrase(s)
  - I3-metadata: 4 suggested option(s), 1 phrase(s)
  - I3-data: 5 suggested option(s)
  - R1.1-metadata: 2 suggested option(s), 3 phrase(s)
  - R1.1-data: 3 suggested option(s), 5 phrase(s)
  - R1.2-metadata: 5 suggested option(s), 2 phrase(s)
  - R1.2-data: 3 suggested option(s), 6 phrase(s)
- Sentinels: Outro=21, Ainda não definido=21, Não se aplica=21

## Agricultura (`confoa-2026-agricultura`, 1.0.0)
- Write action: write
- Questions found: 21/21
- Options offered as free-text phrases (not FERs): 60
- suggestedPhrases entries written: 60
- Type mismatches (suggestion kept, see report section below): 8
  - F1-metadata: 3 suggested option(s), 2 phrase(s)
  - F1-data: 3 suggested option(s), 2 phrase(s)
  - F2: 4 suggested option(s), 2 phrase(s)
  - F3: 2 suggested option(s), 3 phrase(s)
  - F4-metadata: 3 suggested option(s), 2 phrase(s)
  - F4-data: 4 suggested option(s), 2 phrase(s)
  - A1.1-metadata: 3 suggested option(s), 3 phrase(s)
  - A1.1-data: 2 suggested option(s), 4 phrase(s)
  - A1.2-metadata: 2 suggested option(s), 4 phrase(s)
  - A1.2-data: 0 suggested option(s), 6 phrase(s)
  - A2: 0 suggested option(s), 7 phrase(s)
  - I1-metadata: 5 suggested option(s), 2 phrase(s)
  - I1-data: 7 suggested option(s), 1 phrase(s)
  - I2-metadata: 3 suggested option(s), 2 phrase(s)
  - I2-data: 5 suggested option(s), 1 phrase(s)
  - I3-metadata: 4 suggested option(s)
  - I3-data: 4 suggested option(s), 1 phrase(s)
  - R1.1-metadata: 2 suggested option(s), 3 phrase(s)
  - R1.1-data: 3 suggested option(s), 5 phrase(s)
  - R1.2-metadata: 5 suggested option(s), 2 phrase(s)
  - R1.2-data: 3 suggested option(s), 6 phrase(s)
...
- Write action: write
- Questions found: 21/21
- Options offered as free-text phrases (not FERs): 58
- suggestedPhrases entries written: 58
- Type mismatches (suggestion kept, see report section below): 10
  - F1-metadata: 3 suggested option(s), 2 phrase(s)
  - F1-data: 3 suggested option(s), 2 phrase(s)
  - F2: 4 suggested option(s), 1 phrase(s)
  - F3: 2 suggested option(s), 3 phrase(s)
  - F4-metadata: 3 suggested option(s), 2 phrase(s)
  - F4-data: 4 suggested option(s), 2 phrase(s)
  - A1.1-metadata: 3 suggested option(s), 4 phrase(s)
  ...
  - A2: 0 suggested option(s), 7 phrase(s)
  - I1-metadata: 5 suggested option(s), 2 phrase(s)
  - I1-data: 4 suggested option(s), 2 phrase(s)
  - I2-metadata: 5 suggested option(s), 2 phrase(s)
  - I2-data: 6 suggested option(s), 1 phrase(s)
  - I3-metadata: 4 suggested option(s), 1 phrase(s)
  - I3-data: 5 suggested option(s)
  - R1.1-metadata: 2 suggested option(s), 3 phrase(s)
  - R1.1-data: 3 suggested option(s), 3 phrase(s)
  - R1.2-metadata: 5 suggested option(s), 2 phrase(s)
  - R1.2-data: 3 suggested option(s), 5 phrase(s)
- Sentinels: Outro=21, Ainda não definido=21, Não se aplica=21
...
- Type mismatches (suggestion kept, see report section below): 10
  ...
  - I1-metadata: 5 suggested option(s), 2 phrase(s)
  - I1-data: 4 suggested option(s), 2 phrase(s)
  - I2-metadata: 6 suggested option(s), 2 phrase(s)
  - I2-data: 7 suggested option(s), 2 phrase(s)
  - I3-metadata: 4 suggested option(s), 1 phrase(s)
  - I3-data: 5 suggested option(s), 1 phrase(s)
  - R1.1-metadata: 2 suggested option(s), 3 phrase(s)
  - R1.1-data: 3 suggested option(s), 5 phrase(s)
  - R1.2-metadata: 5 suggested option(s), 2 phrase(s)
  - R1.2-data: 3 suggested option(s), 6 phrase(s)
